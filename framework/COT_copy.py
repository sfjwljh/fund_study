...
# 处理指定文件夹下的所有txt文件
file_path=r"C:\Users\LJH\Desktop\基金直播txt\output"
fliter_date="\"2023/11/22\""
date_sql="select code from total where date>{}".format(fliter_date)
cursor.execute(date_sql)
tmp=cursor.fetchall()
codes_date_fliter=[i[0] for i in tmp]
