...
# 运行命令行：
# python run_language_modeling.py     --output_dir=output     --model_type=bert     --model_name_or_path=bert     --do_train     --train_data_file=train.txt       --mlm   --line_by_line  --per_device_train_batch_size=16 > log.txt

# 需要输入的数据没有空行，每一行字符数小于512
"""
